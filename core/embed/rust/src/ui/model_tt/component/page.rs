    ...
    U: AsRef<str> + From<&'static str>,
{
    ...
    fn handle_button(
        ...
        if self.cancel_from_any_page || !self.scrollbar.has_previous_page() {
    ...
    U: AsRef<str> + From<&'static str>,
{
    ...
    fn paint(&mut self) {
        ...
        if self.button_cancel.is_none() {
            self.button_prev.paint();
        } else if self.cancel_from_any_page || !self.scrollbar.has_previous_page() {
