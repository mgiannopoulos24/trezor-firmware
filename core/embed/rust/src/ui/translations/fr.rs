...
pub const TRANSLATIONS: TranslationsGeneral = TranslationsGeneral {
    ...
    cardano__for_account: "pour le compte",
    ...
    eos__yes: "Oui",
    errors__cancelled: "Annulé",
    errors__invalid_session: "Session invalide",
    errors__pin_entry_cancelled: "Entrée d'épingle annulée",
    errors__pin_invalid: "Épingle non valide",
    ...
    language__change_template: "Changer la langue en {}?",
    language__set_default: "Changer la langue par défaut (anglais)?",
    language__title_change: "CHANGER DE LANGUE",
    ...
    pin__diff_from_wipe_code: "La nouvelle broche doit être différente de votre code d'essuyage.",
    ...
    recovery__only_2_to_three_words: "Vous n'aurez qu'à sélectionner les 2-3 premières lettres de chaque mot.",
    recovery__only_first_letters: "Vous n'aurez qu'à sélectionner les 2-3 premières lettres de chaque mot.",
    ...
    reset__check_group_share_title_template: "VÉRIFIER G {} - PARTAGER {}",
    ...
    reset__number_of_shares_info: "= Nombre total de listes de mots uniques utilisées pour le sauvegarde du portefeuille.",
    ...
    reset__select_word_x_of_y_template: "Sélectionnez Word {} de {}:",
    ...
    tutorial__middle_click: "Appuyez à gauche et à droite à la même chose\nIl est temps de confirmer.",
    tutorial__press_and_hold: "Appuyez et maintenez le bouton droit pour\napprouver des opérations importantes.",
    tutorial__ready_to_use: "Tu es prêt à\nUtilisez Trezor.",
    tutorial__scroll_down: "Appuyez à droite pour faire défiler vers le bas pour lire tout le contenu lorsque le texte ne tient pas sur un seul écran.\n\rAppuyez à gauche pour faire défiler vers le haut.",
    tutorial__sure_you_want_skip: "Est-tu sûr que tu\nVous voulez sauter le tutoriel?",
    ...
    tutorial__use_trezor: "Utiliser Trezor par\nCliquez sur les boutons gauche et droit.\n\rContinuer tout droit.",
    ...
    wipe_code__info: "Le code d'essuyer peut être utilisé pour effacer toutes les données de cet appareil.",
