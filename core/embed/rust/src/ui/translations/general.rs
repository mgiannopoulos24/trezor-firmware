...
impl TranslationsGeneral {
    ...
    pub fn get_info(&self, key: &str) -> Option<(&'static str, usize)> {
        match key {
            ...
            "recovery__cancel_dry_run" => Some((self.recovery__cancel_dry_run, 505)),
            "recovery__check_dry_run" => Some((self.recovery__check_dry_run, 506)),
            "recovery__cursor_will_change" => Some((self.recovery__cursor_will_change, 507)),
            "recovery__dry_run_bip39_valid_match" => Some((self.recovery__dry_run_bip39_valid_match, 508)),
            "recovery__dry_run_bip39_valid_mismatch" => Some((self.recovery__dry_run_bip39_valid_mismatch, 509)),
            "recovery__dry_run_slip39_valid_match" => Some((self.recovery__dry_run_slip39_valid_match, 510)),
            "recovery__dry_run_slip39_valid_mismatch" => Some((self.recovery__dry_run_slip39_valid_mismatch, 511)),
            "recovery__enter_any_share" => Some((self.recovery__enter_any_share, 512)),
            "recovery__enter_backup" => Some((self.recovery__enter_backup, 513)),
            "recovery__enter_different_share" => Some((self.recovery__enter_different_share, 514)),
            "recovery__enter_share_from_diff_group" => Some((self.recovery__enter_share_from_diff_group, 515)),
            "recovery__group_num_template" => Some((self.recovery__group_num_template, 516)),
            "recovery__group_threshold_reached" => Some((self.recovery__group_threshold_reached, 517)),
            "recovery__invalid_seed_entered" => Some((self.recovery__invalid_seed_entered, 518)),
            "recovery__invalid_share_entered" => Some((self.recovery__invalid_share_entered, 519)),
            "recovery__more_shares_needed" => Some((self.recovery__more_shares_needed, 520)),
            "recovery__num_of_words" => Some((self.recovery__num_of_words, 521)),
            "recovery__only_2_to_three_words" => Some((self.recovery__only_2_to_three_words, 522)),
            "recovery__only_first_letters" => Some((self.recovery__only_first_letters, 523)),
            ...
            "reset__slip39_checklist_set_sizes" => Some((self.reset__slip39_checklist_set_sizes, 586)),
            ...
            "reset__the_threshold_sets_the_number_of_shares" => Some((self.reset__the_threshold_sets_the_number_of_shares, 590)),
            "reset__threshold_info" => Some((self.reset__threshold_info, 591)),
            "reset__title_backup_is_done" => Some((self.reset__title_backup_is_done, 592)),
            "reset__title_create_wallet" => Some((self.reset__title_create_wallet, 593)),
            "reset__title_create_wallet_shamir" => Some((self.reset__title_create_wallet_shamir, 594)),
            "reset__title_group_threshold" => Some((self.reset__title_group_threshold, 595)),
            "reset__title_number_of_groups" => Some((self.reset__title_number_of_groups, 596)),
            "reset__title_number_of_shares" => Some((self.reset__title_number_of_shares, 597)),
            "reset__title_set_group_threshold" => Some((self.reset__title_set_group_threshold, 598)),
            "reset__title_set_number_of_groups" => Some((self.reset__title_set_number_of_groups, 599)),
            "reset__title_set_number_of_shares" => Some((self.reset__title_set_number_of_shares, 600)),
            "reset__title_set_threshold" => Some((self.reset__title_set_threshold, 601)),
            "reset__to_form_group_template" => Some((self.reset__to_form_group_template, 602)),
            "reset__tos_link" => Some((self.reset__tos_link, 603)),
            "reset__total_number_of_shares_in_group_template" => Some((self.reset__total_number_of_shares_in_group_template, 604)),
            "reset__use_your_backup" => Some((self.reset__use_your_backup, 605)),
            "reset__write_down_words_template" => Some((self.reset__write_down_words_template, 606)),
            "reset__wrong_word_selected" => Some((self.reset__wrong_word_selected, 607)),
            "reset__you_need_one_share" => Some((self.reset__you_need_one_share, 608)),
            "reset__your_backup_is_done" => Some((self.reset__your_backup_is_done, 609)),
            "ripple__confirm_tag" => Some((self.ripple__confirm_tag, 610)),
            "ripple__destination_tag_template" => Some((self.ripple__destination_tag_template, 611)),
            "rotation__change_template" => Some((self.rotation__change_template, 612)),
            "rotation__east" => Some((self.rotation__east, 613)),
            "rotation__north" => Some((self.rotation__north, 614)),
            "rotation__south" => Some((self.rotation__south, 615)),
            "rotation__title_change" => Some((self.rotation__title_change, 616)),
            "rotation__west" => Some((self.rotation__west, 617)),
            "safety_checks__approve_unsafe_always" => Some((self.safety_checks__approve_unsafe_always, 618)),
            "safety_checks__approve_unsafe_temporary" => Some((self.safety_checks__approve_unsafe_temporary, 619)),
            "safety_checks__enforce_strict" => Some((self.safety_checks__enforce_strict, 620)),
            "safety_checks__title" => Some((self.safety_checks__title, 621)),
            "safety_checks__title_safety_override" => Some((self.safety_checks__title_safety_override, 622)),
            "sd_card__all_data_will_be_lost" => Some((self.sd_card__all_data_will_be_lost, 623)),
            "sd_card__card_required" => Some((self.sd_card__card_required, 624)),
            "sd_card__disable" => Some((self.sd_card__disable, 625)),
            "sd_card__disabled" => Some((self.sd_card__disabled, 626)),
            "sd_card__enable" => Some((self.sd_card__enable, 627)),
            "sd_card__enabled" => Some((self.sd_card__enabled, 628)),
            "sd_card__error" => Some((self.sd_card__error, 629)),
            "sd_card__format_card" => Some((self.sd_card__format_card, 630)),
            "sd_card__insert_correct_card" => Some((self.sd_card__insert_correct_card, 631)),
            "sd_card__please_insert" => Some((self.sd_card__please_insert, 632)),
            "sd_card__please_unplug_and_insert" => Some((self.sd_card__please_unplug_and_insert, 633)),
            "sd_card__problem_accessing" => Some((self.sd_card__problem_accessing, 634)),
            "sd_card__refresh" => Some((self.sd_card__refresh, 635)),
            "sd_card__refreshed" => Some((self.sd_card__refreshed, 636)),
            "sd_card__restart" => Some((self.sd_card__restart, 637)),
            "sd_card__title" => Some((self.sd_card__title, 638)),
            "sd_card__title_problem" => Some((self.sd_card__title_problem, 639)),
            "sd_card__unknown_filesystem" => Some((self.sd_card__unknown_filesystem, 640)),
            "sd_card__unplug_and_insert_correct" => Some((self.sd_card__unplug_and_insert_correct, 641)),
            "sd_card__use_different_card" => Some((self.sd_card__use_different_card, 642)),
            "sd_card__wanna_format" => Some((self.sd_card__wanna_format, 643)),
            "sd_card__wrong_sd_card" => Some((self.sd_card__wrong_sd_card, 644)),
            "send__address_path" => Some((self.send__address_path, 645)),
            "send__amount" => Some((self.send__amount, 646)),
            "send__confirm_sending" => Some((self.send__confirm_sending, 647)),
            "send__from_multiple_accounts" => Some((self.send__from_multiple_accounts, 648)),
            "send__including_fee" => Some((self.send__including_fee, 649)),
            "send__maximum_fee" => Some((self.send__maximum_fee, 650)),
            "send__receiving_to_multisig" => Some((self.send__receiving_to_multisig, 651)),
            "send__title_amount" => Some((self.send__title_amount, 652)),
            "send__title_confirm_sending" => Some((self.send__title_confirm_sending, 653)),
            "send__title_joint_transaction" => Some((self.send__title_joint_transaction, 654)),
            "send__title_receiving_to" => Some((self.send__title_receiving_to, 655)),
            "send__title_recipient" => Some((self.send__title_recipient, 656)),
            "send__title_sending" => Some((self.send__title_sending, 657)),
            "send__title_sending_amount" => Some((self.send__title_sending_amount, 658)),
            "send__title_sending_to" => Some((self.send__title_sending_to, 659)),
            "send__to_the_total_amount" => Some((self.send__to_the_total_amount, 660)),
            "send__total_amount" => Some((self.send__total_amount, 661)),
            "send__transaction_id" => Some((self.send__transaction_id, 662)),
            "send__you_are_contributing" => Some((self.send__you_are_contributing, 663)),
            "share_words__words_in_order" => Some((self.share_words__words_in_order, 664)),
            "share_words__wrote_down_all" => Some((self.share_words__wrote_down_all, 665)),
            "sign_message__confirm_address" => Some((self.sign_message__confirm_address, 666)),
            "sign_message__confirm_message" => Some((self.sign_message__confirm_message, 667)),
            "stellar__account" => Some((self.stellar__account, 668)),
            "stellar__account_merge" => Some((self.stellar__account_merge, 669)),
            "stellar__account_thresholds" => Some((self.stellar__account_thresholds, 670)),
            "stellar__add_signer" => Some((self.stellar__add_signer, 671)),
            "stellar__add_trust" => Some((self.stellar__add_trust, 672)),
            "stellar__all_will_be_sent_to" => Some((self.stellar__all_will_be_sent_to, 673)),
            "stellar__allow_trust" => Some((self.stellar__allow_trust, 674)),
            "stellar__asset" => Some((self.stellar__asset, 675)),
            "stellar__bump_sequence" => Some((self.stellar__bump_sequence, 676)),
            "stellar__buying" => Some((self.stellar__buying, 677)),
            "stellar__clear_data" => Some((self.stellar__clear_data, 678)),
            "stellar__clear_flags" => Some((self.stellar__clear_flags, 679)),
            "stellar__confirm_issuer" => Some((self.stellar__confirm_issuer, 680)),
            "stellar__confirm_memo" => Some((self.stellar__confirm_memo, 681)),
            "stellar__confirm_network" => Some((self.stellar__confirm_network, 682)),
            "stellar__confirm_operation" => Some((self.stellar__confirm_operation, 683)),
            "stellar__confirm_stellar" => Some((self.stellar__confirm_stellar, 684)),
            "stellar__confirm_timebounds" => Some((self.stellar__confirm_timebounds, 685)),
            "stellar__create_account" => Some((self.stellar__create_account, 686)),
            "stellar__debited_amount" => Some((self.stellar__debited_amount, 687)),
            "stellar__delete" => Some((self.stellar__delete, 688)),
            "stellar__delete_passive_offer" => Some((self.stellar__delete_passive_offer, 689)),
            "stellar__delete_trust" => Some((self.stellar__delete_trust, 690)),
            "stellar__destination" => Some((self.stellar__destination, 691)),
            "stellar__exchanges_require_memo" => Some((self.stellar__exchanges_require_memo, 692)),
            "stellar__final_confirm" => Some((self.stellar__final_confirm, 693)),
            "stellar__hash" => Some((self.stellar__hash, 694)),
            "stellar__high" => Some((self.stellar__high, 695)),
            "stellar__home_domain" => Some((self.stellar__home_domain, 696)),
            "stellar__inflation" => Some((self.stellar__inflation, 697)),
            "stellar__initial_balance" => Some((self.stellar__initial_balance, 698)),
            "stellar__initialize_signing_with" => Some((self.stellar__initialize_signing_with, 699)),
            "stellar__issuer_template" => Some((self.stellar__issuer_template, 700)),
            "stellar__key" => Some((self.stellar__key, 701)),
            "stellar__limit" => Some((self.stellar__limit, 702)),
            "stellar__low" => Some((self.stellar__low, 703)),
            "stellar__master_weight" => Some((self.stellar__master_weight, 704)),
            "stellar__medium" => Some((self.stellar__medium, 705)),
            "stellar__new_offer" => Some((self.stellar__new_offer, 706)),
            "stellar__new_passive_offer" => Some((self.stellar__new_passive_offer, 707)),
            "stellar__no_memo_set" => Some((self.stellar__no_memo_set, 708)),
            "stellar__no_restriction" => Some((self.stellar__no_restriction, 709)),
            "stellar__on_network_template" => Some((self.stellar__on_network_template, 710)),
            "stellar__path_pay" => Some((self.stellar__path_pay, 711)),
            "stellar__path_pay_at_least" => Some((self.stellar__path_pay_at_least, 712)),
            "stellar__pay" => Some((self.stellar__pay, 713)),
            "stellar__pay_at_most" => Some((self.stellar__pay_at_most, 714)),
            "stellar__preauth_transaction" => Some((self.stellar__preauth_transaction, 715)),
            "stellar__price_per_template" => Some((self.stellar__price_per_template, 716)),
            "stellar__private_network" => Some((self.stellar__private_network, 717)),
            "stellar__remove_signer" => Some((self.stellar__remove_signer, 718)),
            "stellar__revoke_trust" => Some((self.stellar__revoke_trust, 719)),
            "stellar__selling" => Some((self.stellar__selling, 720)),
            "stellar__set_data" => Some((self.stellar__set_data, 721)),
            "stellar__set_flags" => Some((self.stellar__set_flags, 722)),
            "stellar__set_sequence_to_template" => Some((self.stellar__set_sequence_to_template, 723)),
            "stellar__sign_tx_count_template" => Some((self.stellar__sign_tx_count_template, 724)),
            "stellar__sign_tx_fee_template" => Some((self.stellar__sign_tx_fee_template, 725)),
            "stellar__source_account" => Some((self.stellar__source_account, 726)),
            "stellar__testnet_network" => Some((self.stellar__testnet_network, 727)),
            "stellar__trusted_account" => Some((self.stellar__trusted_account, 728)),
            "stellar__update" => Some((self.stellar__update, 729)),
            "stellar__valid_from" => Some((self.stellar__valid_from, 730)),
            "stellar__valid_to" => Some((self.stellar__valid_to, 731)),
            "stellar__value_sha256" => Some((self.stellar__value_sha256, 732)),
            "stellar__wanna_clean_value_key_template" => Some((self.stellar__wanna_clean_value_key_template, 733)),
            "stellar__your_account" => Some((self.stellar__your_account, 734)),
            "tezos__address" => Some((self.tezos__address, 735)),
            "tezos__amount" => Some((self.tezos__amount, 736)),
            "tezos__baker_address" => Some((self.tezos__baker_address, 737)),
            "tezos__balance" => Some((self.tezos__balance, 738)),
            "tezos__ballot" => Some((self.tezos__ballot, 739)),
            "tezos__confirm_delegation" => Some((self.tezos__confirm_delegation, 740)),
            "tezos__confirm_origination" => Some((self.tezos__confirm_origination, 741)),
            "tezos__delegator" => Some((self.tezos__delegator, 742)),
            "tezos__fee" => Some((self.tezos__fee, 743)),
            "tezos__proposal" => Some((self.tezos__proposal, 744)),
            "tezos__register_delegate" => Some((self.tezos__register_delegate, 745)),
            "tezos__remove_delegation" => Some((self.tezos__remove_delegation, 746)),
            "tezos__submit_ballot" => Some((self.tezos__submit_ballot, 747)),
            "tezos__submit_proposal" => Some((self.tezos__submit_proposal, 748)),
            "tezos__submit_proposals" => Some((self.tezos__submit_proposals, 749)),
            "tutorial__middle_click" => Some((self.tutorial__middle_click, 750)),
            "tutorial__press_and_hold" => Some((self.tutorial__press_and_hold, 751)),
            "tutorial__ready_to_use" => Some((self.tutorial__ready_to_use, 752)),
            "tutorial__scroll_down" => Some((self.tutorial__scroll_down, 753)),
            "tutorial__sure_you_want_skip" => Some((self.tutorial__sure_you_want_skip, 754)),
            "tutorial__title_hello" => Some((self.tutorial__title_hello, 755)),
            "tutorial__title_screen_scroll" => Some((self.tutorial__title_screen_scroll, 756)),
            "tutorial__title_skip" => Some((self.tutorial__title_skip, 757)),
            "tutorial__title_tutorial_complete" => Some((self.tutorial__title_tutorial_complete, 758)),
            "tutorial__use_trezor" => Some((self.tutorial__use_trezor, 759)),
            "tutorial__welcome_press_right" => Some((self.tutorial__welcome_press_right, 760)),
            "u2f__get" => Some((self.u2f__get, 761)),
            "u2f__set_template" => Some((self.u2f__set_template, 762)),
            "u2f__title_get" => Some((self.u2f__title_get, 763)),
            "u2f__title_set" => Some((self.u2f__title_set, 764)),
            "wipe__info" => Some((self.wipe__info, 765)),
            "wipe__title" => Some((self.wipe__title, 766)),
            "wipe__want_to_wipe" => Some((self.wipe__want_to_wipe, 767)),
            "wipe_code__change" => Some((self.wipe_code__change, 768)),
            "wipe_code__changed" => Some((self.wipe_code__changed, 769)),
            "wipe_code__diff_from_pin" => Some((self.wipe_code__diff_from_pin, 770)),
            "wipe_code__disabled" => Some((self.wipe_code__disabled, 771)),
            "wipe_code__enabled" => Some((self.wipe_code__enabled, 772)),
            "wipe_code__enter_new" => Some((self.wipe_code__enter_new, 773)),
            "wipe_code__info" => Some((self.wipe_code__info, 774)),
            "wipe_code__invalid" => Some((self.wipe_code__invalid, 775)),
            "wipe_code__mismatch" => Some((self.wipe_code__mismatch, 776)),
            "wipe_code__reenter" => Some((self.wipe_code__reenter, 777)),
            "wipe_code__reenter_to_confirm" => Some((self.wipe_code__reenter_to_confirm, 778)),
            "wipe_code__title_check" => Some((self.wipe_code__title_check, 779)),
            "wipe_code__title_invalid" => Some((self.wipe_code__title_invalid, 780)),
            "wipe_code__title_mismatch" => Some((self.wipe_code__title_mismatch, 781)),
            ...
            "word_count__title" => Some((self.word_count__title, 785)),
            "words__are_you_sure" => Some((self.words__are_you_sure, 786)),
            "words__buying" => Some((self.words__buying, 787)),
            "words__continue_anyway" => Some((self.words__continue_anyway, 788)),
            "words__continue_with" => Some((self.words__continue_with, 789)),
            "words__error" => Some((self.words__error, 790)),
            "words__from" => Some((self.words__from, 791)),
            "words__keep_it_safe" => Some((self.words__keep_it_safe, 792)),
            "words__know_what_your_doing" => Some((self.words__know_what_your_doing, 793)),
            "words__my_trezor" => Some((self.words__my_trezor, 794)),
            "words__outputs" => Some((self.words__outputs, 795)),
            "words__please_check_again" => Some((self.words__please_check_again, 796)),
            "words__please_try_again" => Some((self.words__please_try_again, 797)),
            "words__really_wanna" => Some((self.words__really_wanna, 798)),
            "words__sign" => Some((self.words__sign, 799)),
            "words__title_check" => Some((self.words__title_check, 800)),
            "words__title_group" => Some((self.words__title_group, 801)),
            "words__title_remember" => Some((self.words__title_remember, 802)),
            "words__title_share" => Some((self.words__title_share, 803)),
            "words__title_shares" => Some((self.words__title_shares, 804)),
            "words__title_success" => Some((self.words__title_success, 805)),
            "words__title_summary" => Some((self.words__title_summary, 806)),
            "words__title_threshold" => Some((self.words__title_threshold, 807)),
            "words__unknown" => Some((self.words__unknown, 808)),
            "words__warning" => Some((self.words__warning, 809)),
            _ => None,
        }
    }
}
