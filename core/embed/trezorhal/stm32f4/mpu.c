...
void mpu_config_firmware(void) {
  ...
  //       never) MPU->RBAR = FLASH_BASE | MPU_REGION_NUMBER0; MPU->RASR =
  //       MPU_RASR_ENABLE_Msk | MPU_RASR_ATTR_FLASH |
  ...
  //   // Firmware extra (0x08120000 - 0x081FFFFF, 7 * 128 KiB = 1024 KiB except
  //   1/8
