...
class TestTrezorHostProtocol(unittest.TestCase):
    ...
    def test_channel_allocation(self):
        ...
        self.assertEqual(len(thp_v3.CHANNELS), 0)
        self.assertFalse(test_counter in thp_v3.CHANNELS)
        ...
        self.assertTrue(test_counter in thp_v3.CHANNELS)
        self.assertEqual(len(thp_v3.CHANNELS), 1)

    def test_channel_default_state_is_TH1(self):
        self.assertEqual(thp_v3.CHANNELS[4660].get_channel_state(), ChannelState.TH1)

    def test_skip_pairing(self):
        config.init()
        config.wipe()
        channel = thp_v3.CHANNELS[4660]
